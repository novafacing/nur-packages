...

{
  ...
  python37Packages = rec {
    ...
    angr = pkgs.python37.pkgs.callPackage ./pkgs/python-modules/angr {
      inherit archinfo ailment cffi claripy cle cooldict mulpyplexer pyvex unicorn cppheaderparser;
    };

    archinfo = pkgs.python37.pkgs.callPackage ./pkgs/python-modules/archinfo {};

    cffi = pkgs.python37.pkgs.callPackage ./pkgs/python-modules/cffi {};
